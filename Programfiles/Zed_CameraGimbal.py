...
def init():
    ...
    return zed, obj_runtime_param, fps_counter, fps, ser
...
def process_objects(objects, img_cv, depth_map, ser):
    global selected_object
...
def main_loop(zed, obj_runtime_param, fps_counter, fps, ser):
    objects = sl.Objects()
    ...
    while True:
        if zed.grab() == sl.ERROR_CODE.SUCCESS:
            ...
            process_objects(objects, img_cv, depth_map, ser)
...
def main():
    zed, obj_runtime_param, fps_counter, fps, ser = init()
    startup_message
    main_loop(zed, obj_runtime_param, fps_counter, fps, ser)
